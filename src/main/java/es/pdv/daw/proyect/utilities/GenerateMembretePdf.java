...
public class GenerateMembretePdf extends PdfPageEventHelper {
	...
	private PdfPTable creaDatosEmpresa(EmpresaRepository empresaRepository) {
		...
		//Se crea una celda con un padding de 10 y se le añade el encabezado.
	...
	private PdfPTable creaDatosCliente(AlbaranValidate albaranValidate) {
		...
		// Se crean las frases con los datos del cliente, el parrafo y se añade a la celda.
		Phrase nombreCliente = new Phrase("Cliente: "+albaranValidate.getAlbaran().getCliente().getNombreCliente()+"\n");
