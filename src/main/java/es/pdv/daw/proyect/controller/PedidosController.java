...
public class PedidosController {
	...
	public AlbaranValidate creaAlbaran(AlbaranValidate albaranValidate,
			Cliente cliente,
			Albaran albaran){
	...
	public AlbaranValidate insertaLinea(AlbaranValidate albaranValidate,
			Rosal rosal,
			Albaran albaran,
	...
	public AlbaranValidate eliminaLinea(AlbaranValidate albaranValidate,
			Rosal rosal,
			Albaran albaran,
			DetalleAlbaran detalleAlbaran){
	...
	public AlbaranValidate eliminaAlbaran(AlbaranValidate albaranValidate,
			Albaran albaran){
	...
	public AlbaranValidate editaAlbaran(AlbaranValidate albaranValidate,
			Albaran albaran){
	...
	public AlbaranPdf generaPdf(AlbaranValidate albaranValidate,
			Albaran albaran,
